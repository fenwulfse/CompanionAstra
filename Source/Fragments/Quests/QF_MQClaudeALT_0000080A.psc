...
Scriptname Fragments:Quests:QF_MQClaudeALT_0000080A Extends Quest Hidden
...
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 0 (reset/init)")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 5 start")
endif
...
if EnableRecoveryBranch && !ForceBypassRecovery
  if MQ302 && MQ302.GetStage() >= 10
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT recovery route: MQ302 stage >= 10")
    endif
...
if PlayerInstitute_Destroyed
  if PlayerInstitute_Destroyed.GetValue() >= 1.0
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT hard fail: Institute already destroyed")
    endif
...
Actor ClaudeActor = Alias_Claude.GetActorReference()
if ClaudeActor
  if DisallowedCompanionFaction
    ClaudeActor.AddToFaction(DisallowedCompanionFaction)
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT suppressed standard greeting (early)")
    endif
  endif
endif
...
; Move Claude AND Codsworth to the player
; Narrative: Claude tracked the vault opening, brought Codsworth as proof of trust
if ClaudeActor
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT moving Claude to player")
  endif
  ClaudeActor.MoveTo(Game.GetPlayer())
  ClaudeActor.EvaluatePackage()
endif

; Codsworth deferred — keeping bootstrap simple for now

; Scene is handled by high-priority Greeting topic (Priority 70 Hello)
; firing when player approaches Claude exterior.
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 6 start (escort branch)")
endif
...
if ClaudeActor
  ...
  if PlayerFaction
    ClaudeActor.AddToFaction(PlayerFaction)
  endif
  if DisallowedCompanionFaction
    ClaudeActor.RemoveFromFaction(DisallowedCompanionFaction)
  endif
  FollowersScript.GetScript().SetCompanion(ClaudeActor)
  ClaudeActor.EvaluatePackage()
  Debug.Notification("MQClaudeALT: Claude is now your companion")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 7 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 9 start (red rocket - dogmeat pickup)")
endif

; Stop bootstrap scene so Claude isn't stuck in it
if BootstrapScene
  BootstrapScene.Stop()
endif
...
; Claude keeps following — SetCompanion from stage 6 handles it.
; No FollowerWait here; both Claude and Dogmeat follow to Concord.
...
if DogmeatActor
  ...
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT Dogmeat following via quest alias (MQ106 pattern)")
  endif
endif
;END CODE
EndFunction
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 8 start (workshop gate)")
  Debug.Notification("MQClaudeALT: Stage 8 active. Use Sanctuary Workshop once.")
endif
...
if playerRef && WorkshopWorkbenchBase
  ...
  if workshopRef
    ...
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT workshop gate armed on " + workshopRef)
      Debug.Notification("MQClaudeALT: Workshop gate armed.")
    endif
  else
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT workshop gate fallback: no nearby WorkshopWorkbench")
      Debug.Notification("MQClaudeALT: Workshop not found. Advancing to stage 9.")
    endif
    SetObjectiveCompleted(8)
    SetStage(9)
  endif
  ...
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT workshop gate fallback: missing player or WorkshopWorkbenchBase")
    Debug.Notification("MQClaudeALT: Workshop gate fallback. Advancing to stage 9.")
  endif
  SetObjectiveCompleted(8)
  SetStage(9)
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 10 start")
endif
...
if ClaudeActor
  ...
  FollowersScript.GetScript().FollowerFollow(ClaudeActor)
  ClaudeActor.EvaluatePackage()
endif
...
elseif DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 10 waiting for MQ102 stage 50 (Codsworth Concord handoff)")
endif
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 15 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 20 start")
endif
NotNowChosen = true
SetObjectiveCompleted(10)
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 25 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 30 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 35 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 40 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 45 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 50 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 55 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 60 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 65 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 70 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 75 start")
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 80 start")
  if MQ206Min
    Debug.Trace(self + " MQClaudeALT stage 80 snapshot MQ206Min stage=" + MQ206Min.GetStage())
  endif
  if MQ302Min
    Debug.Trace(self + " MQClaudeALT stage 80 snapshot MQ302Min stage=" + MQ302Min.GetStage())
  endif
endif
...
;BEGIN CODE
if DebugTrace
  Debug.Trace(self + " MQClaudeALT stage 85 start")
endif
...
; vanilla Nuclear Option startup while MQClaudeALT owns this branch.
...
if tunnelGate
  ...
  tunnelGate.SetOpen()
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT stage 85 unlocked/opened Public Works tunnel gate failsafe")
  endif
endif
;END CODE
EndFunction
...
if WorkshopGateArmed && akSender == SanctuaryWorkshopRef
  if aStart
    ...
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT workshop mode entered at Sanctuary")
    endif
  ...
  elseif WorkshopModeSeenStart
    ...
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT workshop mode exit detected; advancing to stage 9")
      Debug.Notification("MQClaudeALT: Workshop mode exit detected. Stage 9.")
    endif
    SetObjectiveCompleted(8)
    SetStage(9)
    handledSanctuaryGate = true
...
if MinRecruitQuickResolveArmed && !MinRecruitQuickResolveApplied && akSender == MinRecruitWorkshopRef
  if aStart
    ...
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT MinRecruit workshop mode entered")
    endif
...
if WorkshopGateArmed && akSender == SanctuaryWorkshopRef && akActionRef == playerRef
  ...
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT workshop activate detected; advancing to stage 9")
    Debug.Notification("MQClaudeALT: Workshop activated. Stage 9.")
  endif
...
if MinRecruitQuickResolveArmed && !MinRecruitQuickResolveApplied
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT player location changed; refreshing MinRecruit quick-resolve watcher")
  endif
...
if DebugTrace
  Debug.Trace(self + " MQClaudeALT MinRecruit quick-resolve arm requested")
endif
RefreshMinRecruitQuickResolveBinding()
EndFunction
...
if targetWorkshop
  if MinRecruitWorkshopRef != targetWorkshop
    ...
    if DebugTrace
      Debug.Trace(self + " MQClaudeALT MinRecruit quick-resolve watcher armed on " + targetWorkshop)
      Debug.Notification("MQClaudeALT: First Step quick-assist armed.")
    endif
  endif
elseif DebugTrace
  Debug.Trace(self + " MQClaudeALT waiting for MinRecruit00 settlement workshop alias")
endif
EndFunction
...
if !mq302MinFrag
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT tunnel prime skipped (" + sourceTag + "): MQ302Min fragment cast failed")
  endif
  return
endif
...
if DebugTrace
  Debug.Trace(self + " MQClaudeALT tunnel prime applied from " + sourceTag)
endif
EndFunction
...
if !mq207Quest.GetStageDone(5)
  ...
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT scanner bypass primed MQ207 stage 5 from " + sourceTag)
  endif
endif
EndFunction
...
if relayTriggerRef && !relayTriggerRef.IsDisabled()
  ...
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT nuclear suppression disabled relay trigger from " + sourceTag)
  endif
endif
...
if mq302MinQuest && mq302MinQuest.IsRunning()
  mq302MinQuest.Stop()
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT nuclear suppression stopped MQ302Min from " + sourceTag)
  endif
endif
EndFunction
...
if relayTriggerRef && relayTriggerRef.IsDisabled()
  ...
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT nuclear suppression released relay trigger from " + sourceTag)
  endif
endif
EndFunction
...
if DebugTrace
  Debug.Trace(self + " MQClaudeALT MQ103 objective suppression applied from " + sourceTag)
endif
EndFunction
...
if !recruitQuest
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT quick-resolve skipped (" + sourceTag + "): MinRecruit00 not found")
  endif
  return
endif
...
if !recruitQuest.IsRunning()
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT quick-resolve skipped (" + sourceTag + "): MinRecruit00 not running")
  endif
  return
endif
...
if DebugTrace
  Debug.Trace(self + " MQClaudeALT applying MinRecruit00 quick-resolve from " + sourceTag)
endif
...
if recruitQuest.GetStageDone(400) == 1
  ...
  CleanupMinRecruitQuickResolveWatcher()
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT MinRecruit00 advanced to stage 400; report to Preston")
    Debug.Notification("MQClaudeALT: First Step triage complete. Report to Preston.")
  endif
else
  if DebugTrace
    Debug.Trace(self + " MQClaudeALT MinRecruit00 stage 400 not confirmed yet; retry scheduled")
  endif
  RefreshMinRecruitQuickResolveBinding()
endif
EndFunction
...
;BEGIN CODE
; Trade: open Claude's inventory for the player
Actor ClaudeActor = Alias_Claude.GetActorReference()
if ClaudeActor
  ClaudeActor.OpenInventory(true)
endif
;END CODE
EndFunction
;END FRAGMENT
...
; --- Aliases ---
ReferenceAlias Property Alias_Claude Auto
